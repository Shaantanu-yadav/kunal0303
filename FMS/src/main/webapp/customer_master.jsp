...
<body> 
	<nav class="navbar navbar-light navbar-expand-xl"
		...
		<div class="container-fluid">
			<img src="../../assets/img/gcpl_logo.png" height="40px"><a
				...
				style="padding: 0; margin-bottom: 7px; width: 300px; height: 30px;"><span
				class="text-start"
	...
	<div class="container"
		style="padding-left: 15px; padding-right: 16px; padding-top: 0px;">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-2 offset-md-0">
					<a href="customer_form.jsp">
						<button class="btn btn-light btn-sm border-primary" type="button"
							style="margin-top: 3px; hover-color: blue; border-color: #3d6ff4">ADD
							NEW</button>
				...
				<table class="tbl cell-border hover display compact"
					...
					<thead>
						<tr>
							...
							<th style="width: 15%; text-align:center">Customer Code</th>
							<th style="width: 10%; text-align:center">Customer Name</th>
							<th style="width: 15%; text-align:center">Product Group</th>
							<th style="width: 10%;text-align:center">Sales Rep</th>
							<th style="width: 20%;text-align:center">SAP Customer code</th>
