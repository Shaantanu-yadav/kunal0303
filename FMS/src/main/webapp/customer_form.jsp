					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="#">Tanker Master</a><a
								...
								class="dropdown-item" href="#">Customer Master</a><a
				...
				<form action="/InsertData" method="get";
					...
					<div class="row">
						...
						<div class="col-xl-2" style="width: 500px;">
							<input class="border-secondary form-control" type="text"
								 name="customerName" id="customerName" style="margin-top: 8px; margin-bottom: 8px;">
					...
					<div class="row">
						<div class="col-xl-2 offset-xl-3 align-self-center">
							<label class="form-label" style="font-size: 15px;"><strong>SalesRep</strong></label>
					...
					<div class="row" style="margin-top: 0px;">
						<div class="col-xl-2 offset-xl-3 align-self-center">
							<label class="form-label" style="font-size: 15px;"><strong>Remarks</strong></label>
						</div>
						<div class="col-xl-4"
					...
					<div class="row">
						<div
							...
							<button class="btn btn-primary" type="button"
								style="margin-left: 11px; margin-right: 11px; color: var(- -bs-black);"
						...
						<div
							...
							<a href="customer_master.jsp"><button
							 class="btn btn-light" type="button"
								style="margin-left: 10px; margin-right: 10px; border-color: var(- -bs-btn-active-border-color);">Cancel</button></a>
						</div>
					</div>
					<!--Confirmation Modal -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="goalModal" style="color:red;">Confirmation!</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">Do you really want to Save this data?</div>
