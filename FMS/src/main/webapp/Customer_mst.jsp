...
<body style="font-size: 13px;">
	<nav class="navbar navbar-light navbar-expand-md bg-light"
		style="font-weight: bold; border-bottom: 1px solid #3d6ff4;">
		<div class="container-fluid">
			<a class="navbar-brand" href="#" style="padding: 0;"><img
				height="40px" src="../../assets/img/gcpl_trans_logo.png"><span
				style="font-size: 1rem; font-weight: bold; margin-left: 0.5rem;">Container
			...
			<div class="collapse navbar-collapse" id="navcol-1">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item dropdown"><a
						class="dropdown-toggle nav-link" aria-expanded="true"
						data-bs-toggle="dropdown" href="#" style="background:#3d6ff4;color:white">Customer
							Masters</a>
						<div class="dropdown-menu" data-bs-popper="none">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" data-bs-popper="none"
							style="padding-right: 2px; margin-right: -15px; padding-left: 0px; margin-left: -115px;">
				...
				<div class="col-md-2 offset-md-0">
					<a href="Customer_form.jsp">
						<button class="btn btn-primary" type="button"
							style="margin-top: 4px; hover-color:blue;border-color:#3d6ff4; color:#3d6ff4">ADD NEW</button>
